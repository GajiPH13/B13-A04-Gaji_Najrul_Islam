    ...
    for (let interview of interviewList) {
        ...
        div.innerHTML = `
            ...
            <div class="flex justify-between" >
                    <div>
                        <h3  class=" companyName text-[18px] font-bold text-black mb-1">${interview.companyName}</h3>
                        <p  class="position text-[18px] text-gray-500">${interview.position}</p>
                    </div>
                    <div >
                        <button  class="btnRemove w-8 h-8 bg-red-500 text-white rounded-full">X</button>
                    </div>
                    </div>
...
function renderRejected() {
    ...
    for (let rejected of rejectedList) {
        ...
        div.innerHTML = `
            ...
            <div class="flex justify-between" >
                    <div>
                        <h3  class=" companyName text-[18px] font-bold text-black mb-1">${rejected.companyName}</h3>
                        <p  class="position text-[18px] text-gray-500">${rejected.position}</p>
                    </div>
                    <div >
                        <button  class="btnRemove w-8 h-8 bg-red-500 text-white rounded-full">X</button>
                    </div>
